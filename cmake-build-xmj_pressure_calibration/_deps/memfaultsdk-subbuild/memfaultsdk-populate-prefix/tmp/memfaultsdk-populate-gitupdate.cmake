...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "0.16.1"
  WORKING_DIRECTORY "/Users/victorsowa/xMoonJelly_fw/cmake-build-xmj_pressure_calibration/_deps/memfaultsdk-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/0.16.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0.16.1")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/memfault/memfault-firmware-sdk.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/victorsowa/xMoonJelly_fw/cmake-build-xmj_pressure_calibration/_deps/memfaultsdk-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/victorsowa/xMoonJelly_fw/cmake-build-xmj_pressure_calibration/_deps/memfaultsdk-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
